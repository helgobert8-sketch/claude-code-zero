# Beispiel-Vorlage: AGENTS.md (von Alex Finn, „Henry V1")

> Alex' eigene Rules-Datei für seinen Coding-Agenten. **Beispiel/Referenz** — passe Befehle
> (npm/convex) an dein Projekt an. Liegt im Projekt-Root als `AGENTS.md` (Codex) bzw. `CLAUDE.md`
> (Claude Code) und verweist auf `ops/templates/linear-task.md`.
